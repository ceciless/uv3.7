%exo 45 p151   
%estimateur de Kalman pour un systeme dynamique simple
...
y1=30;
y2=-6;
Gbeta=1; % la consigne sur polycopie est inverse
Galpha=eye(2,2);
xhat0=[0;0];
Gx0=100*eye(2,2);
draw_ellipse(xhat0,Gx0,0.9,'black',3); hold on;
%selon la fonction Kalman
...
draw_ellipse(xhat3,Gx3,0.9,'magenda',2)